defmodule FibServerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FibServerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FibServerWeb.Gettext, "errors", msg, opts)
    end
  end
